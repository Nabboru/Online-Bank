class TransactionsController < ApplicationController
  ...
  before_action :redirect_if_not_admin, only: [:edit]
  def index
  ...
  def update
    ...
    if @transaction.update(payment_params)
      redirect_to transactions_path(account_id: @transaction.sendingAccount_id)
    else
      render 'edit'
    end
  end
